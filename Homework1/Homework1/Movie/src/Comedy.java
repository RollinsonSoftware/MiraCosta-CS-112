 ...
 *None.
 **/
public class Comedy extends Rental
{
	public Comedy()
	{
		super();
	}
	public Comedy(int daysLate, int idNum, String rating, String title, boolean rented, int customerId)
	{
