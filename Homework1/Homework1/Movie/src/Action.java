 ...
 *None.
 **/
public class Action extends Rental
{
	...
	public Action(int daysLate, int idNum, String rating, String title, boolean rented, int customerId)
	{
